  ...
  return (
    <div className="container text-[#FFFFFF] ">
      ...
      <div className="lg:px-20 md:px-10">
        ...
        <div
          className="lg:mt-40 mx-auto lg:h-[560px] h-[600px] pt-10 w-[327px] mb-10 md:h-[720px] md:w-[689px] lg:w-[100%] bg-[#D87D4A] rounded-[8px] lg:relative lg:flex lg:items-center lg:justify-center
          ...
          <div className="flex flex-col  h-[100%]  lg:flex-row md:flex-col justify-between md:h-full  lg:gap-20 md:gap-3 md:py-10 lg:py-0 lg:items-end">
            <div className="flex flex-col  mx-auto lg:h-full md:h-auto  lg:justify-end md:justify-center">
              <Image
                ...
                width={410.23}
                height={493}
                className="drop-shadow-2xl md:w-[197px] w-[172.25px] h-[207px] md:h-[237px] lg:w-[410.23px] lg:h-[493px]"
              />
            </div>

            <div className="flex flex-col mt-2 md:mx-auto space-y-3 pt-10 md:justify-between md:text-center h-full  bg-transparent lg:w-[349px] lg:h-[303px] h-auto text-center lg:text-left px-8 lg:mb-16">
        ...
        {/* next */}
        <div className="h-[424px] flex-col gap-6 items-center md:items-stretch md:flex-row md:h-[320px] md:w-[689px] md:my-10 lg:h-[340px] lg:w-[100%] flex justify-between ">
          <div className="w-[327px] h-[200px] md:h-auto md:w-[339px] lg:w-[540px] rounded-[8px] bg-[url('/pods.png')] bg-cover bg-center"></div>

          <div className="w-[327px] h-[200px] md:h-auto md:w-[339px] lg:w-[540px] rounded-[8px] flex flex-col justify-center px-6 md:px-13 lg:px-30 bg-[#F1F1F1]">
        ...
        {/* next */}
        <div className="my-16 h-auto flex flex-col-reverse gap-10 items-center md:items-stretch md:my-10 md:flex md:flex-col-reverse md:gap-12 md:w-[689px] lg:my-40 lg:h-[588px] lg:w-[1110px] lg:flex lg:justify-between lg:flex-row lg:items-center">
          <div className="w-[327px] text-center px-6 md:w-[573px] md:h-[270px] md:text-center md:mx-auto lg:w-[445px] lg:h-[295px] lg:flex lg:flex-col lg:justify-between lg:text-left lg:px-0">
            ...
            <p className="text-[#000000] text-[15px] leading-[25px] opacity-50 md:opacity-100 md:h-[150px]">
          ...
          <div className="rounded-[8px] w-[327px] h-[300px] md:w-[689px] md:h-[300px] lg:w-[540px] lg:h-[588px] bg-[url('/user.png')] bg-cover bg-center"></div>
        </div>
      </div>
    </div>
  );
